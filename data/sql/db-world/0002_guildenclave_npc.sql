...
VALUES (900000, 'Guild Enclave Broker', 'Guild Services', 80, 80, 35, 1, 1, 7, 1, 1.14286, '', 'GuildEnclaveBroker');
...
INSERT INTO creature_template (entry, name, subname, minlevel, maxlevel, faction, npcflag, unit_class, type, speed_walk, speed_run, AIName, ScriptName)
VALUES (900001, 'Guild Enclave Broker', 'Guild Services', 80, 80, 35, 1, 1, 7, 1, 1.14286, '', 'GuildEnclaveBroker');
...
INSERT INTO creature_template (entry, name, subname, minlevel, maxlevel, faction, npcflag, unit_class, type, speed_walk, speed_run, AIName, ScriptName)
VALUES (900002, 'Guild Enclave Salesman', 'Guild Services', 80, 80, 35, 1, 1, 7, 1, 1.14286, '', 'GuildEnclaveSalesman');
...
INSERT INTO creature_template (entry, name, subname, minlevel, maxlevel, faction, npcflag, unit_class, type, speed_walk, speed_run, AIName, ScriptName)
VALUES (900003, 'Guild Enclave Salesman', 'Guild Services', 80, 80, 35, 1, 1, 7, 1, 1.14286, '', 'GuildEnclaveSalesman');
